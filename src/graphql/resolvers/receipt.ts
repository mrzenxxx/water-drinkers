...
export const Receipt: ReceiptResolvers<GraphQLContext> = {
  /**
   * Адрес выдачи файла. Хранилище ещё не выбрано (открытый вопрос №6), поэтому
   * наружу отдаётся ссылка на приложение, а не на хранилище: сменить S3 на диск
   * можно будет, не трогая ни схему, ни клиента. Сам обработчик — этап 6.
   */
