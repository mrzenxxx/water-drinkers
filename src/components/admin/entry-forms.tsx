 ...
 * аудита с указанием, кто и за кого их создал. Взнос при этом **всё равно
 * проходит подтверждение** — иначе исчезает разделение «внёс» и «проверил»,
 * и очередь §6.7 перестаёт быть проверкой.
 */
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Попадёт в очередь подтверждений наравне с остальными: внёс и проверил — это два разных
          действия.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ActionForm action={addContributionForAction} submitLabel="Внести взнос">
          ...
          <p className="text-muted-foreground text-xs">
            Чек прикладывается на этапе 6 — распознавания чеков пока нет, и выдумывать его данные
