...
/**
 * Сколько объявлений может висеть закреплёнными одновременно (§6.12).
 *
 * Три инструкции наверху ещё читаются; десять — уже второй список, где снова
 * всё тонет. Считаются объявления вне архива, черновики включительно.
 */
