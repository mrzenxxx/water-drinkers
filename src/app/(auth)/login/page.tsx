 ...
 *
 * Своей регистрации нет — учётные данные заводит администратор. Под формой
 * сказано, что логин и пароль он выдаёт по запросу, и под этой строкой стоят
 * знаки мессенджеров, которыми запрос и делается: Telegram
      ...
      <div className="glass rounded-2xl p-6 sm:p-8">
        ...
        {contacts.length > 0 && (
          <div className="mt-6 flex flex-col items-center gap-4 border-t pt-6 text-center">
            ...
            {/*
              Своей подписи у знаков здесь нет: строка над ними уже сказала,
              зачем писать администратору, и второе приглашение рядом с первым
              повторяло бы ту же мысль другими словами.
            */}
            <AdminContactLinks contacts={contacts} stacked />
          </div>
        )}
      </div>
    </main>
