...
- Учётная запись: рабочая почта, роль, дата вступления в фонд, дата выхода,
  если он был. Всё это меняет только администратор (§6.7).
...
Больше о человеке приложение не знает и знать не должно: почта, имя, фамилия —
исчерпывающий список (§7).
...
5. При первом входе — заполнение имени и фамилии на `/welcome`. Дальше имя правится в профиле (§6.10).
