...
**Верхняя полоса** — один ряд: знак приложения (там, где его нет в панели),
две цифры, ради которых сюда заходят, и кнопки справа.

- Цифры: личный баланс и остаток фонда. Ответ на «должен или нет» виден с
  любого экрана, а не только с главной. На узких экранах плитки уходят —
  там та же цифра встречает человека на главной, крупно и с объяснением.
- Кнопки справа: форма навигации, тема, участник. Значок участника — крайний
  справа: он ведёт в профиль, а профиль это конец ряда, а не его середина.
